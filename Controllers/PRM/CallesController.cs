...
// ***********************************************************************
// <copyright file="CallesController.cs" company="Full Conectados Ltda">
...
{
    /// <summary>
    /// Clase controladora para API - CallesController.
    /// </summary>
    [Produces("application/json")]
    [Route("api/prm/[controller]")]
    [ApiController]
    public class CallesController : CoreController
    {
        /// <summary>
        /// The bs
        /// </summary>
        private readonly Business.PRM.Calles _bs;

        /// <summary>
        /// Initializes a new instance of the <see cref="CallesController" /> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        public CallesController(IConfiguration configuration)
        {
            _bs = new Business.PRM.Calles(configuration);
        }
        ...
        public CoreResponse Get(string filter = null)
        {
            ...
            var opt = new CoreFilter<Calle>();
            if (filter != null)
            {
                var tmp = new CoreRequest() { Data = filter };
                opt = tmp.GetObject<CoreFilter<Calle>>();
            }
