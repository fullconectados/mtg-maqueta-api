...
// ***********************************************************************
// <copyright file="RegionesController.cs" company="Full Conectados Ltda">
...
{
    /// <summary>
    /// Clase controladora para API - RegionesController.
    /// </summary>
    [Produces("application/json")]
    [Route("api/prm/[controller]")]
    [ApiController]
    public class RegionesController : CoreController
    {
        /// <summary>
        /// The bs
        /// </summary>
        private readonly Business.PRM.Regiones _bs;

        /// <summary>
        /// Initializes a new instance of the <see cref="RegionesController" /> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        public RegionesController(IConfiguration configuration)
        {
            _bs = new Business.PRM.Regiones(configuration);
        }
        ...
        public CoreResponse Get(string filter = null)
        {
            ...
            var opt = new CoreFilter<Region>();
            if (filter != null)
            {
                var tmp = new CoreRequest() { Data = filter };
                opt = tmp.GetObject<CoreFilter<Region>>();
            }
        ...
        {
            var tmp = value.GetObject<Region>();
            tmp.Id = 0;
